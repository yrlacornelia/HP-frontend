...
<div id="deleteModal" aria-hidden="true"  className={` ${isModalOpen ? '' : 'hidden'} overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 flex z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full `}>
